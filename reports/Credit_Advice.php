		...
		<div class="row">
			<div class="left" style="width: 100%; padding: 0px; float: left;">			
				<table style="width: 100%; float: left;" cellspacing="0" cellpadding="0">
					<tbody>						
                        <tr >
							<th colspan= "2" align=left style="font-weight: bold; padding-bottom: 7px; font-size: 14px; border-top: 1px solid black">We have credited today Home Office Current Account for the following:</th>
						</tr>
						<tr >							
