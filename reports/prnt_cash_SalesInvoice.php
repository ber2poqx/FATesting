...
<title>To Print Receipt, CASH SALES INVOICE</title>
<style type="text/css">
	.main{
		width: 8.3in;
		height: 7in;
...
<body>
	...
	<div class="main printable">
		...
		<div style="height: 3.8cm"></div> <!-- header height -->
		...
		<div class="row">
			...
			<div class="line1" style="width: 4.65cm;"></div> <!-- Sold_to and Date spacing -->
		...
		<div>
			<div class="line1" style="width: 16.58cm;"></div>
				...
				<?php						  
					...
					if (db_num_rows($result) > 0)
					{
						...
						{	
							...
							echo '<tr >';
							echo '<td align=center style="padding-left: 5px; width: 3.7cm; text-align: center; padding-bottom: 0.15cm;">'.($myrow2["Qty"]).'</td>';
							echo '<td align=center style="padding-left: 5px;width: 2.1cm; text-align: center; padding-bottom: 0.15cm;">'.($myrow2["Unit"]).'</td>';
							echo '<td align=center style="padding-left: 5px;width: 6.5cm; text-align: left; padding-bottom: 0.15cm;">'.($myrow2["Article"]).'</td>';
