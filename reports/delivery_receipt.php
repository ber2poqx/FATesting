...
?>				
		...
		<div class="left" style="width: 100%; padding:10px ;font-size: 100%;">
			Checked By: <input type="text" class="underline_input">
			&nbsp;Packed By: <input type="text" class="underline_input">
			&nbsp;Received By: <input type="text" class="underline_input">
		</div>
		
		<div class="left" style="width: 100%; padding:10px 20px;font-size: 100%;position: relative;
    bottom: -25%;">
			Prepared By: <input type="text" class="underline_input">
			&nbsp;&nbsp;Box: <input type="text" class="underline_input" style="width: 50px;">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Transport Mode: <input type="text" class="underline_input" style="width: 75px;">
		</div>
		<div class="left" style="width: 100%; padding:5px 20px;font-size: 100%;position: relative;
    bottom: -25%;">
			Encoded &nbsp;By: <input type="text" class="underline_input">
			&nbsp;Pack: <input type="text" class="underline_input" style="width: 50px;">
			
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Time:
 <input type="text" class="underline_input" style="width: 75px;">
		</div>
		<div class="left" style="width: 100%; padding:5px 20px;font-size: 100%;position: relative;
    bottom: -25%;">
		</div>
