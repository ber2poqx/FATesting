...
if(!is_null($action) || !empty($action)){
    switch ($action) {
        ...
        case 'view':
            ...
            $result = get_all_complimentary_item($start,$limit,$querystr,$comp_stat,$search_ref,false,'');
            $total_result = get_all_complimentary_item($start,$limit,$querystr,$comp_stat,$search_ref,true,'');
            //$total_result = get_all_serial($start,$end,$querystr,$catcode,$branchcode,true);
            $total = DB_num_rows($result);
            while ($myrow = db_fetch($result))
            {                
