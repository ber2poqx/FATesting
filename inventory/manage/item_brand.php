...
***********************************************************************/
$page_security = 'SA_BRAND';
$path_to_root = "../..";
include($path_to_root . "/includes/session.inc");

page(_($help_context = "Brand Masterfile Setup"));
...
if ($Mode=='ADD_ITEM' || $Mode=='UPDATE_ITEM') 
{
	...
	if ($input_error !=1) {
		...
		if($selected_id != '')
			...
			display_notification(_('New brand has been added'));
		$Mode = 'RESET';
	}
}
...
if ($Mode == 'Delete')
{
	...
	if (brand_used($selected_id))
	{
		display_error(_("Cannot delete this brand because items have been created using this brand."));
...
if ($selected_id != '' && brand_used($selected_id)){
