...
$result = get_all_distributor(check_value('show_inactive'));
...
while ($myrow = db_fetch($result))
{
	...
	inactive_control_cell($code, $myrow["inactive"], 'item_distributor', 'id');
...
if ($selected_id != '') 
{
 	...
 	if ($Mode == 'Edit') {
		...
		$myrow1 = get_distributor($selected_id);
...
if ($selected_id != '' && distributor_used($selected_id)){
