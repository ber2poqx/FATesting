...
function handle_update_item()
{
	$id = $_POST['LineNo'];
   	$_SESSION['adj_items']->update_cart_item($id, input_num('qty'), 
		input_num('std_cost'),$_POST['manufacture_date'],$_POST['expire_date'],$_POST['lot_no']);
	line_start_focus();
}
...
function handle_new_item()
{
	...
	//input_num('qty'), input_num('std_cost'),$_POST['manufacture_date'],$_POST['expire_date'],$_POST['lot_no']);
	add_to_order($_SESSION['adj_items'], $_POST['stock_id'], 
	input_num('qty'), input_num('std_cost'),$_POST['manufacture_date'],$_POST['expire_date'],$_POST['lot_no']);
	line_start_focus();
}
