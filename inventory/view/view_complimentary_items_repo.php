...
while ($adjustment = db_fetch($adjustment_items))
{
	...
	if (!$header_shown)
	{
		...
		end_row();
		comments_display_row(ST_COMPLIMENTARYITEMREPO, $trans_no);
...
is_voided_display(ST_COMPLIMENTARYITEMREPO, $trans_no, _("This adjustment has been voided."));

end_page(true, false, false, ST_COMPLIMENTARYITEMREPO, $trans_no);
