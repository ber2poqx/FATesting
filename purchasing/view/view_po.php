...
read_po($_GET['trans_no'], $purchase_order, false, false);
echo "<br>";
...
$th = array(
	_("Item Code"), _("Item Description"), _("Color Description - (Code)"), _("Quantity"), _("Unit"), _("Price"),
	//_("Requested By"), 
	_("Line Total"), _("Quantity Received"), _("Quantity Invoiced")
);

if ($purchase_order->category_id != 14)
	array_remove($th, 2);
table_header($th);
$total = $k = 0;
$overdue_items = false;
