...
/**********************************************************************
 ...
 Created by Albert 07/02/2022
 ***********************************************************************/
 $page_security = 'SA_POCLOSESTATUS';
$path_to_root = "..";
...
page(_($help_context = "Close Purchase Order # " . $_GET['PONumber']), false, false, "", $js);
...
textarea_row(_("Remarks:"), 'remarks', null, 70, 4);

end_table(1);
if (isset($_GET['branch_coy'])) {
    set_global_connection($_GET['branch_coy']);
}
if (check_status_po($_GET['PONumber']) == "Open") {
    submit_center_first('close_po', _("Proceed Closed PO"), '', 'default');
}
