...
page(_($help_context = "GRN Serial Items"), false, false, "", $js);
...
function display_po_receive_items()
{
    ...
    $th = array(_("Item Code"), _("Description"), _("Ordered"), _("Units"), _("Received"),
    	_("Outstanding"), _("This Delivery"), _("Price"), _("Total"),_(" "));
    table_header($th);
    ...
    if (count($_SESSION['PO']->line_items)> 0 )
    {
       	foreach ($_SESSION['PO']->line_items as $ln_itm)
       	{
			...
			//echo "<td><a href='item_serial_details.php?grnid=".$ln_itm->line_no."'>"._("Details")."</a></td>";
			end_row();
       	}
    }
...
display_heading(_("Serialise Items to Receive"));
