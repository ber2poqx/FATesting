...
function print_po()
{
	...
	$cols = array(15, 120, 150, 300, 340, 385, 450, 515);
	...
	for ($i = $from; $i <= $to; $i++)
	{
		...
		
		{
			...
			//	$rep->TextCol(1, 2,	$myrow2['item_code'], -2); *Empty slot
			} else
				$rep->TextCol(0, 1,	$myrow2['description'], -2);	
				//$rep->TextCol(2, 3,	sql2date($myrow2['delivery_date']), -2);
				
			
				//	$rep->TextCol(2, 3,	$myrow2['COLOR'], -2);	* Slot used to display data for COLOR			
