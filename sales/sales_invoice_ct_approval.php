 ...
 ***********************************************************************/
$page_security = 'SA_SALES_CT_APPROVAL';
$path_to_root = "..";
...
page(_($help_context = "Draft Change Term # " . $_GET['CTNumber']), false, false, "", $js);
create_cart(ST_SITERMMOD, $_GET['CTNumber']);
...
if (isset($_POST['Approved'])) {
    $_SESSION['Items']->status = "1";
	$_SESSION['Items']->approval_remarks = $_POST['Comments'];
    $update_message = update_change_term_status($_SESSION['Items']);
	processing_end();
