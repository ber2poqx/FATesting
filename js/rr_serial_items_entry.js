...
function window_show(trans_no){
	...
	var columnSerialItemModel = [
		...
		{header:'Item Code', dataIndex:'grnitem_id', sortable:true, width:80},
		{header:'Serial/Engine No.', dataIndex:'grnitem_name', sortable:true},
        {header:'Chasis No.', dataIndex:'grnitem_qty', sortable:false, width:100, align:'left'},
        {header:'Action', xtype:'actioncolumn', align:'center', width:50, hidden: false,
			items:[{
