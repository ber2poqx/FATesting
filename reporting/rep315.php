...
function print_PO_Report()
{
    ...
    while ($ACRBCR = db_fetch($res))
    {
    	...
    	if ($group == 0) {
            if ($CATEGORY != $ACRBCR['CATEGORY']) {
                ...
                if ($CATEGORY != '') {
                    ...
                    $rep->AmountCol(16, 17, $Balancesubtotal);
                    $rep->AmountCol(17, 18, $overduesubtotal);
                    $rep->AmountCol(18, 19, $pastduesubtotal);
                    $rep->AmountCol(20, 21, $unrecoveredsubtotal);
                    $rep->Line($rep->row  - 4);
                    $rep->NewLine(2);
                    $rep->Font();
        ...
        $rep->AmountCol(15, 16, $ACRBCR['monthly_amount']); 
        $rep->AmountCol(16, 17, $ACRBCR['balance']); 
        $rep->AmountCol(17, 18, $overdue);
        $rep->AmountCol(18, 19, $pastdue);
        $rep->TextCol(19, 20, $ACRBCR['']);
        $rep->AmountCol(20, 21, $ACRBCR['unrecovered_cost']);
        $rep->NewLine(1);
    ...
    $rep->TextCol(13, 15, _('Grand Total'));
  	$rep->AmountCol(16, 17, $Balancegrandtotal);
    $rep->AmountCol(17, 18, $overduegrandtotal);
    $rep->AmountCol(18, 19, $pastduegrandtotal);
    $rep->AmountCol(20, 21, $unrecoveredgrandtotal);
    $rep->End();
}